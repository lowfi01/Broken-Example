...
namespace API
{
  public class Program
  {
    public static async Task Main(string[] args)
    {
      ...
      // using will ensure that once we have finished running our action it will be disposed of in memory.
      ...
      try
      {
        ...
        await Seed.SeedData(context, userManager);// run seed method
      }
      catch (Exception ex)
      {
